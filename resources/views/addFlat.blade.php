        ...
        enctype="multipart/form-data" >
            ...
            @method('POST')
              <div class="form-row">
                ...
                <div class="form-group col-md-6">
                  <label>rooms</label>
                  <input type="number" min="0" step="1" class="form-control" name="num_room"   placeholder="room number">
                </div>
                <div class="form-group col-md-6">
                  <label>beds</label>
                  <input type="number" min="0" step="1" class="form-control" name="bed"   placeholder="beds">
                </div>
                <div class="form-group col-md-6">
                  <label>bathroom</label>
                  <input type="number" min="0" step="1" class="form-control" name="bathroom"   placeholder="bathroom">
                </div>
                <div class="form-group col-md-6">
                  <label>space area</label>
                  <input type="number" min="0" step="1" class="form-control" name="mq"   placeholder="space area">
                </div>
                <div class="form-group col-md-6">
                  <label>img</label>
