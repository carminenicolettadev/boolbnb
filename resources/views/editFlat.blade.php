          ...
          <form  action="{{ route('updateFlat', $singleFlat->id)}}"  method="post" id="form-flat" >
            ...
            @method('POST')
              <div class="form-row">
                ...
                <div class="form-group col-md-6">
                  <label>rooms</label>
                  <input type="number" class="form-control" value="{{$detailFlat[0]->num_room}}" name="num_room" required  placeholder="room number">
                </div>

                <div class="form-group col-md-6">
                  <label>beds</label>
                  <input type="number" class="form-control" value="{{$detailFlat[0]->bed}}" name="bed" required  placeholder="beds">
                </div>

                <div class="form-group col-md-6">
                  <label>bathroom</label>
                  <input type="number" class="form-control" value="{{$detailFlat[0]->bathroom}}" name="bathroom" required  placeholder="bathroom">
                </div>


                <div class="form-group col-md-6">
                  <label>space area</label>
                  <input type="number" class="form-control" value="{{$detailFlat[0]->mq}}" name="mq" required  placeholder="space area">
                </div>
